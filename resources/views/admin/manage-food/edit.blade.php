        ...
        <form action="{{ route('admin.manage-food.update', $food->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-6 flex flex-col gap-y-4">
                ...
                <div class="flex items-center justify-end gap-x-4">
                    ...
                    <button type="submit" class="flex items-center justify-center transition-all duration-300 font-semibold text-primary bg-transparent border-2 border-primary hover:bg-primary hover:text-white px-4 py-1.5 text-base rounded-full cursor-pointer">Edit Makanan</button>
                </div>
            </div>
        </form>
    </div>
